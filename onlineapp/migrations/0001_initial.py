# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2019-11-04 17:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Course',
            fields=[
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='onlineapp.Profile')),
                ('Institute_Name', models.CharField(max_length=100)),
                ('Faculty_Name', models.CharField(max_length=100)),
                ('New_Batche', models.DateField()),
                ('Duration', models.CharField(max_length=100)),
                ('Class_Timings', models.TimeField()),
                ('Free_Demo_Video', models.URLField(validators=[django.core.validators.URLValidator()])),
            ],
        ),
    ]
